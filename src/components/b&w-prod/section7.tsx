      ...
      >
        ...
        >
          ...
          <p className="text-sm max-w-[320px] leading-relaxed">
            We are deeply grateful for the love, prayers, and support given as
        ...
        >
          ...
          <p className="text-white text-sm">
            The Beginning of Every Beautiful Moment
          </p>
          <div className="flex gap-4 items-center">
            <motion.a
              ...
              className="bg-white flex gap-1 items-center text-[#2C2C2C] font-semibold px-2 py-1 rounded-2xl hover:bg-gray-100 hover:scale-105 transition cursor-pointer"
            >
