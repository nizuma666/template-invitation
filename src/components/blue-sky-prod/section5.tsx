            ...
            <div className="relative mx-auto aspect-[16/12] rounded-xl  overflow-hidden shadow-lg">
                ...
                <div className="absolute inset-0 bg-[#629BC0]/70 flex flex-col justify-center p-6 text-white">
                    ...
                    <button
                        ...
                        className="bg-white text-[#629BC0] px-12 py-3 rounded-lg font-bold shadow-md hover:bg-gray-100 transition-all"
                    >
                        See Gift Option
                    </button>
                </div>
                ...
                {isOpen && (
                    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <button
                                onClick={() => setIsOpen(false)}
                                className="w-full mt-10 py-4 bg-[#629BC0] text-white rounded-lg font-bold text-lg shadow-lg shadow-blue-200 hover:bg-[#5386a8] transition-all"
                            >
                                Tutup
                            </button>
                        </motion.div>
