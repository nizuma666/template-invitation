      ...
      <div className="flex flex-col gap-6 mb-12">
        ...
        >
          <div className="flex-1 ml-2">
            ...
            <p className="text-xs lg:text-sm text-[#909090] mb-4 leading-tight font-sarabun">
              Putri dari {content?.nama_pengantin_bapak_wanita} &<br /> Ibu {content?.nama_pengantin_ibu_wanita}
            </p>
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-xs lg:text-sm text-[#909090] mb-4 leading-tight font-sarabun">
              Putra dari {content?.nama_pengantin_bapak_pria} &<br /> Ibu {content?.nama_pengantin_ibu_pria}
            </p>
