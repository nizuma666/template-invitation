      ...
      <div className="flex flex-col gap-6 mb-12">
        ...
        >
          <div className="flex-1 ml-2">
            <h3 className="text-2xl italic leading-5 text-[#2C2C2C] mb-1 font-corsiva">{content?.nama_pengantin_wanita}</h3>
        ...
        >
          ...
          <div className="flex-1">
            <h3 className="text-2xl italic leading-5 text-[#2C2C2C] mb-1 font-corsiva">{content?.nama_pengantin_pria}</h3>
            <p className="text-xs lg:text-sm text-[#909090] mb-4 leading-tight font-sarabun">
