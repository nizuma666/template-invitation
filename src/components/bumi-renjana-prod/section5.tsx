  ...
  const journeys = [
    {
      ...
      desc: "Love grew not from perfection, but from understanding, patience, and shared dreams.",
      align: "right"
    },
    {
      id: 2,
        ...
        <AnimatePresence mode="popLayout" initial={false}>
          {displayedJourneys?.map((item, index) => (
            <motion.div 
              ...
              className="relative w-full aspect-[16/10] rounded-[20px] overflow-hidden shadow-sm mb-6 last:mb-0"
            >
              <Image 
