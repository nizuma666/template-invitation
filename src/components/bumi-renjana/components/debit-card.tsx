    ...
    return (
        <div className="relative overflow-hidden rounded-2xl p-6 h-52 flex flex-col justify-between shadow-sm border border-gray-100 bg-white group">
            ...
            <div className="relative z-20 flex justify-between items-end">
                ...
                <button
                    onClick={handleCopy}
                    className={`flex items-center gap-2 px-5 py-2 rounded-full text-xs font-bold transition-all active:scale-90 shadow-md ${
                        copied 
                        ? "bg-[#2D9E64] text-white" 
                        : "bg-[#D89F83] text-white hover:bg-[#c58d72]"
                    }`}
                >
