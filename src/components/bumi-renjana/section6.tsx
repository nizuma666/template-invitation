    ...
    {isDrawerOpen && (
        <div className="fixed inset-0 z-[9999] flex flex-col justify-end">
            ...
            <motion.div
                ...
                className="relative bg-white rounded-t-[18px] p-4 max-h-screen z-[10000] font-sarabun"
            >
                {/* Header Form */}
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full border border-gray-200 rounded-xl px-2 py-2 focus:border-[#D89F83] outline-none transition-all text-gray-600 placeholder:text-gray-300"
                            required
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className={`flex-1 py-2 rounded-xl border text-[15px] transition-all ${
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full border border-gray-200 rounded-xl px-4 py-3 focus:border-[#D89F83] outline-none transition-all resize-none text-gray-600 placeholder:text-gray-300"
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-3 pt-4">
                        <button 
                            type="submit"
                            className="w-full py-2 bg-[#D89F83] text-white rounded-xl font-bold text-lg active:scale-[0.98] transition-transform shadow-sm"
                        >
                            Kirim
                        </button>
                        <button
                            type="button"
                            onClick={() => setIsDrawerOpen(false)}
                            className="w-full py-2 bg-white text-brown border border-brown rounded-xl font-bold text-lg active:scale-[0.98] transition-transform shadow-sm"
                        >
                            Tutup
                        </button>
                    </div>
