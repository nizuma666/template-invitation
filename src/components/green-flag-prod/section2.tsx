        ...
        >
            ...
            <div className="flex flex-col gap-10 items-center mt-30 relative">
                <motion.div
                    ...
                    variants={fadeUp}
                >
                    <p className="text-heading1 font-bold text-green-primary text-center">Dua Hati, Satu Doa</p>
                ...
                >
                    ...
                    <motion.div
                        ...
                        variants={fadeUp}
                    >
                        <p className="text-[40px] font-allura text-green-primary">{data.nama_pengantin_wanita}</p>
                        <p className="text-neutral-text3">Putri dari</p>
                        <p className="text-center text-[#212121]">Bpk. {data.nama_pengantin_bapak_wanita} & Ibu {data.nama_pengantin_ibu_wanita}</p>
                    </motion.div>
                </motion.div>
                ...
                >
                    ...
                    <motion.div
                        ...
                        variants={fadeUp}
                    >
                        <p className="text-[40px] font-allura text-green-primary">{data.nama_pengantin_pria}</p>
                        <p className="text-neutral-text3">Putra dari</p>
                        <p className="text-center text-[#212121]">Bpk. {data.nama_pengantin_bapak_pria} & Ibu {data.nama_pengantin_ibu_pria}</p>
                    </motion.div>
                </motion.div>
            </div >
        </motion.div >
