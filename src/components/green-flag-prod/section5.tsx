    ...
    return (
        <div ref={ref} className="py-10 px-6 flex flex-col gap-10 bg-[#FFF7EE]">
            ...
            >
                ...
                <p className="text-neutral-text4 text-center">Kami percaya, setiap doa yang tulus adalah berkah. Namun bila ingin turut berbagi kasih, berikut cara yang kita sediakan:</p>
            </motion.div>
