    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col lg:flex-row gap-2 lg:gap-4">
                <button type="button" className="border border-rose1 rounded-lg py-2 lg:py-4 px-8 bg-white text-rose1 font-semibold flex items-center justify-center gap-2 cursor-pointer">Pesan <ChevronRight className="text-rose1" /></button>
                <button type="button" className="border bg-rose1 rounded-lg py-2 lg:py-4 px-8 text-white font-bold flex items-center justify-center cursor-pointer">Demo <ChevronRight /></button>
            </div>
        </div>
    )
}
